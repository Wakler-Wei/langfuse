...
export function ModernSessionViewDropdownMenu({
  ...
  return (
    <DropdownMenuContent align="end" className="w-72">
      <DropdownMenuLabel>{tAuto("system_presets_b9988e5")}</DropdownMenuLabel>
      ...
      <DropdownMenuSeparator />
      <DropdownMenuLabel>{tAuto("saved_views_3aae72c")}</DropdownMenuLabel>
      ...
      <DropdownMenuSeparator />
      <DropdownMenuItemWithSecondaryAction
        title={tAuto("manage_views_af03a0e")}
        icon={Settings2}
        onClick={controls.onManageViews}
      />
      <DropdownMenuSeparator />
      <DropdownMenuItemWithSecondaryAction
        title={tAuto("apply_custom_filter_d286955")}
        icon={Filter}
