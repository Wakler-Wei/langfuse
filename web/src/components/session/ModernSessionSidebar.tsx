...
function ObservationListRows({
  ...
  if (state.type === "empty") {
    return (
      <p className="text-muted-foreground -mx-1 px-1 py-2 text-xs">
        {state.hasFilters
          ? tAuto("no_matching_child_observations_95be084")
          : tAuto("no_child_observations_fd64719")}
      </p>
    );
  }
  ...
  if (state.type === "trace-io-only") {
    return (
      <div className="border-border bg-border/40 text-foreground -mx-1 mt-2 rounded-sm border px-2 py-1.5 text-xs">
        {tAuto("trace_level_i_o_only_ce8c476")}{" "}
      </div>
    );
  }
  ...
  if (state.type === "error") {
    return (
      <p className="text-muted-foreground -mx-1 px-1 py-2 text-xs">
        {tAuto("failed_to_load_observations_e7970a1")}{" "}
      </p>
    );
  }
      ...
      >
        <div className="flex w-full items-center gap-2">
          ...
          <button
            ...
            aria-label={
              isCollapsed
                ? tAuto("expand_turn_f7d75c4")
                : tAuto("collapse_turn_74f4e1f")
            }
...
export function ModernSessionSidebar(
  ...
  if (props.state === "loading") {
    return (
      <div
        role="complementary"
        aria-label={tAuto("session_observations_5a1d784")}
        aria-busy="true"
  ...
  const filterSummaryLabel = filterControls.activeViewName
    ? tAuto("view_value0_7095756", {
        value0: String(filterControls.activeViewName),
      })
    : tAuto("value0_active_filter_value1_e6ceefb", {
        value0: String(filterControls.activeFilterCount),
        value1: String(filterControls.activeFilterCount === 1 ? "" : "s"),
      });
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-1 px-2 py-2.5">
          <div className="relative min-w-0 flex-1">
            ...
            <Input
              ...
              aria-label={tAuto("search_turns_and_observations_0d74617")}
              placeholder={tAuto("search_turns_and_observations_0d74617")}
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                aria-label={tAuto("filter_observations_c0816fb")}
              >
      ...
      <div
        ref={setListElement}
        role="region"
        aria-label={tAuto("session_turns_959630b")}
