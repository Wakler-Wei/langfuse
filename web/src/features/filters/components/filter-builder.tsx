        ...
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            {!organization?.aiFeaturesEnabled ? (
              ...
              tAuto("create_filter_with_ai_7c965e8")
            )}
          </Button>
          {showAiFilter && (
            ...
            <tbody>
              {filterState.map((filter, i) => {
                ...
                const columnLabel = column
                  ? column.name
                  : tAuto("column_65ba00e");
                return (
                  <tr key={i}>
                    <td className="p-1 text-sm">
                      {i === 0 ? tAuto("where_525f61b") : tAuto("and_a01e33f")}
                    </td>
                    <td className="flex gap-2 p-1">
                      ...
                      <Popover>
                        ...
                        >
                          <InputCommand>
                            <InputCommandInput
                              placeholder={tAuto("search_for_column_f5724bd")}
                              variant="bottom"
                            />
                            <InputCommandList>
                              <InputCommandEmpty>
                                {tAuto("no_options_found_c91bf3b")}{" "}
                              </InputCommandEmpty>
                              <InputCommandGroup>
                                {columns.map((option) => {
